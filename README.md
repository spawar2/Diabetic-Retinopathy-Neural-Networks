# Diabetic-Retinopathy-Neural-Networks.
...
diabetic-retinopathy-detection.ipynb: Imaging data read, split, plotting, noise removal, Convolution 2D network training, confusion matrix, accuracy, sensitivity, specificity, precision, recall, confusion matrix, log-loss, and area under curve and receiver operating characteristic, AUC-ROC evaluation.
